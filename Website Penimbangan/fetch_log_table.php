...
/**
 * fetch_log_table.php
 * Mengembalikan JSON berisi:
 *   - log_html   : baris <tr> untuk tabel log penimbangan hari ini
 *   - notif_html : HTML notifikasi overload terbaru hari ini
 *
 * Dipanggil oleh fetchLogTable() di index.php setiap 3 detik.
 */
header('Content-Type: application/json');
include 'koneksi.php';

// ====================================================
// 1. LOG PENIMBANGAN HARI INI (50 TERAKHIR)
// ====================================================
$sql_log = "SELECT 
...
// ====================================================
// 2. NOTIFIKASI OVERLOAD HARI INI (5 TERAKHIR)
// ====================================================
$sql_notif = "SELECT 
                  plat_nomor,
                  berat_aktual,
